! function (e, t) {
        ...
        function l(n) {
                ...
                return function () {
                        var e, t = u(n);
                        return C(this, i ? (e = u(this)
                                .constructor, Reflect.construct(t, arguments, e)) : t.apply(this, arguments))
                }
        }
        var f = !1
                , t = {};
        ...
        function v(e) {
                return -1 !== navigator.userAgent.toLocaleLowerCase()
                        .indexOf(e)
        }
        var U = function () {
                        try {
        ...
        function T(e, t) {
                e.addEventListener(t, function (e) {
                        return (e = e || window.event)
                                .returnValue = !1, e.preventDefault(), !1
                })
        }
        var D = 8;
                        ...
                        return c(t, [{
                                ...
                                , value: function () {
                                        ...
                                        this.lastTime = 0, this.reg = /./, g(this.reg), this.reg.toString = function () {
                                                var e;
                                                return q ? (e = (new Date)
                                                        .getTime(), t.lastTime && e - t.lastTime < 100 ? t.onDevToolOpen() : t.lastTime = e) : F && t.onDevToolOpen(), ""
                                        }
                                }
                        }, {
                                key: "detect"
        ...
        function L(e) {
                ne(e)
                        , function () {
                                ...
                                return
                        }() || (Z(), re(), ("all" === w.detectors ? Object.keys(pe) : w.detectors)
                                .forEach(function (e) {
                                        new pe[e]
                                }))
        }
        var ye, R, z, A;
        return L.md5 = ce, L.version = "0.3.1", L.DetectorType = j, L.isDevToolOpened = W, "undefined" != typeof document && (ye = document.querySelector("[protect]")) && (R = ["disable-menu", "disable-select", "disable-copy", "disable-cut", "disable-paste", "clear-log"], z = ["interval"], A = {}, ["md5", "url", "tk-name", "detectors"].concat(R, z)
                .forEach(function (e) {
